...
Usage:
    ...
    python -m tools.esm.pack_template_dump Travel Sleep Eat
    python -m tools.esm.pack_template_dump 00019714
    python -m tools.esm.pack_template_dump --instances-of Follow --limit 2
    python -m tools.esm.pack_template_dump --python Travel Sandbox Eat Sleep
"""
...
def emit_python(packs, names):
    ...
    print('# Auto-generated by tools/esm/pack_template_dump.py — do not hand-edit.')
