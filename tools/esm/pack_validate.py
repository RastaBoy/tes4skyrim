...
Usage:
    ...
    python tools/esm/pack_validate.py <esm> --ref <Skyrim.esm>   # compare templates
    python tools/esm/pack_validate.py <esm> --fid 036632         # one package
    python tools/esm/pack_validate.py <esm> --summary
"""
