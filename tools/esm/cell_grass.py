...
Usage:
    python tools/esm/cell_grass.py <export_dir> --wrld <FormID_or_EditorID> \
        --cell X,Y [--cell X,Y ...]
    python tools/esm/cell_grass.py export/Oblivion.esm --wrld Tamriel --cell 20,20 --cell 10,10
"""
import argparse
