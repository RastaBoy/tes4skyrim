...
Usage:
    python tools/audit/missing_mesh_refs.py --plugin TWMP_Valenwood_Elsweyr.esp
    python tools/audit/missing_mesh_refs.py --plugin X.esp --region -60 -40 -60 -40
    python tools/audit/missing_mesh_refs.py --plugin X.esp --max 40
"""
