...
Usage:
  python tools/audit/override_audit.py export/Translation.esp [--out-root output]
  python tools/audit/override_audit.py export/Translation.esp --keys   # unmapped detail
"""
import argparse
import os
import sys
