...
Usage:
    python tools/validate/esm_group_anchors.py output/<Plugin>/<Plugin>
    python tools/validate/esm_group_anchors.py <plugin> --verbose
    python tools/validate/esm_group_anchors.py <plugin> --order-only
    python tools/validate/esm_group_anchors.py <plugin> --reference <Skyrim.esm>
"""
