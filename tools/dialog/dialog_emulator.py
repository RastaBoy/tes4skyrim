...
Usage:
    # Test a single NPC
    python tools/dialog/dialog_emulator.py output/oblivion.esm/Oblivion.esm --npc Jauffre

    # Compare what an NPC sees in two ESMs
    python tools/dialog/dialog_emulator.py output/oblivion.esm/Oblivion.esm --npc Jauffre --compare Skyrim.esm

    # Batch test all NPCs, report issues
    python tools/dialog/dialog_emulator.py output/oblivion.esm/Oblivion.esm --batch

    # Test a specific quest's dialog
    python tools/dialog/dialog_emulator.py output/oblivion.esm/Oblivion.esm --quest MQ00
...
from tools.esm.tes5_esm_reader import read_tes5_file, TES5Record, _get, _zstring
