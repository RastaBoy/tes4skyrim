...
Usage:
    ...
    python tools/dialog/oblivion_dialog_emulator.py export/Oblivion.esm --list-npcs rat
"""
...
# Engine tables
# --------------------------------------------------------------------------
_TABLES = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))), 'tes4_export', 'oblivion_engine_tables.json')
