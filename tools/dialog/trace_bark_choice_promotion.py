...
Usage:
    python -m tools.dialog.trace_bark_choice_promotion export/Oblivion.esm
    python -m tools.dialog.trace_bark_choice_promotion export/Oblivion.esm --only AnswerNegative,SadGeneral
    python -m tools.dialog.trace_bark_choice_promotion export/Oblivion.esm --promoted-only
"""
import argparse
import sys
