...
Usage:
    python tools/nif/skin_partition_dump.py <nif> [<nif> ...]
    python tools/nif/skin_partition_dump.py <dir>          # scans *.nif recursively
    python tools/nif/skin_partition_dump.py --slots <nif>  # one line per shape/slot
"""
